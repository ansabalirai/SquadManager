...
//---------------------------------------------------------------------------------------
class XComGameState_LWSquadManager extends XComGameState_BaseObject config(SquadManager);

var transient StateObjectReference LaunchingMissionSquad;
var StateObjectReference LastMissionSquad;
...
// Rai - Probably not needed for vanilla
/*
...
function XComGameState_LWPersistentSquad GetSquadAfterMission(StateObjectReference MissionRef)
{
	local XComGameState_LWPersistentSquad Squad;
	local int idx;
	local XComGameStateHistory History;
	...
	Squad = XComGameState_LWPersistentSquad(`XCOMHISTORY.GetGameStateForObjectID(LastMissionSquad.ObjectID));
	if(Squad != none) 
		{
			Squad.SquadSoldiersOnMission = `XCOMHQ.Squad;
			Squad.InitInfiltration(`XCOMHQ.MissionRef);
			return Squad;
		}
	...
	// 	{
	// 		//Squad.GetReference().ObjectID == LaunchingMissionSquad.ObjectID
	// 		Squad.SquadSoldiersOnMission = `XCOMHQ.Squad;
	// 		Squad.InitInfiltration(`XCOMHQ.MissionRef);
	// 		return Squad;
	// 	}
...
// Rai - 
function UpdateSquadPreMission(XComGameState UpdateState)
{
	local XComGameStateHistory History;
...
// Rai - Testing
exec function JumpToSquadManagement()
{
	GoToSquadManagement();
}